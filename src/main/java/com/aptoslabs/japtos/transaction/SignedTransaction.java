...
import com.aptoslabs.japtos.transaction.authenticator.TransactionAuthenticatorEd25519;
import com.aptoslabs.japtos.transaction.authenticator.TransactionAuthenticatorMultiEd25519;
...
public class SignedTransaction implements Serializable {
    ...
    public SignedTransaction(RawTransaction rawTransaction, AccountAuthenticator authenticator) {
        ...
        if (authenticator instanceof Ed25519Authenticator) {
            ...
            throw new IllegalArgumentException("Only Ed25519 and MultiEd25519 authenticators are supported");
        }
    }
