...
public class KeylessMultiKeyTest {
    ...
    void testKeylessMultiKeyAddressDerivation() throws Exception {
        ...
        System.out.println("Entropy (first 32 chars): " + entropy);
        ...
        System.out.println("Pass wallet address: " + passWallet.getAccountAddress());
        System.out.println("Pass wallet public key: " + passWallet.getPublicKey());
        ...
        System.out.println("Keyless public key ISS: " + keylessKey.getIss());
    ...
    void testKeylessPublicKeyDeserialization() throws Exception {
        ...
        System.out.println("KeylessPublicKey:");
        System.out.println("  ISS: " + keylessKey.getIss());
        System.out.println("  ID Commitment: " + keylessKey.getIdCommitment().length + " bytes");
        System.out.println("  toString(): " + keylessKey.toString());
